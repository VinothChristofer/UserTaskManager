...
ActiveRecord::Schema[7.0].define(version: 2023_07_30_194603) do
  ...
  create_table "weather_info", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["task_id"], name: "index_weather_info_on_task_id"
  end
